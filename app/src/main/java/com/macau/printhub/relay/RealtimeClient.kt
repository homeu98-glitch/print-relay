...
/**
 * Supabase Realtime (Phoenix channel over WebSocket) client.
 * Wake-up signal only — actual job data fetched via POST /claim RPC.
 * Ported from print-agent-android, identical protocol.
 */
